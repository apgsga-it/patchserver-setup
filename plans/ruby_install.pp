plan piper::ruby_install(
  ...
  rbenv::gem { 'apscli': ruby_version => 'jruby-9.2.11.1', source => "https://${lookup('gem::user::name')}:${lookup('gem::user::pw')}@${gem_repo}" }
  rbenv::gem { 'tty-spinner': ruby_version => 'jruby-9.2.11.1'}
  rbenv::gem { 'apsmig': ruby_version => 'jruby-9.2.11.1' , source => "https://${lookup('gem::user::name')}:${lookup('gem::user::pw')}@${gem_repo}"}
  }
}
